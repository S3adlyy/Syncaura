...
include 'C:\xamp\htdocs\integration3\views\config.php';
include 'C:/xamp/htdocs/integration3/models/pack.php';
...
class PackController
{
    ...
    public function updatePack($pack, $id)
    {
        ...
        try {
            ...
            if (isset($_FILES["NouvelleImage"]) && $_FILES["NouvelleImage"]["error"] === UPLOAD_ERR_OK) {
                ...
                $deplacer_img = move_uploaded_file($tmp_nom, "C:\xamp\htdocs\projetrayen\view\backend\image_bdd" . $nouveau_nom_img); // Save the file to the server
    ...
    public function deletePack($id)
    {
        ...
        try {
            ...
            $imagePath = "C:/xamp/htdocs/projetrayen/view/backend/image_bdd/" . $imageName;
