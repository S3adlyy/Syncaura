...
.content-container {
  ...
  background: rgba(255, 255, 255, 0.7); /* Semi-transparent white for better visibility */
  width: 70%; /* Increased width */
  height: 80%; /* Larger height to take more space vertically */
  padding: 20px;
  border-radius: 15px; /* Slightly more rounded corners */
  box-shadow: 0 6px 10px rgba(0, 0, 0, 0.15); /* Deeper shadow for better contrast */
  overflow-y: auto; /* Allow scrolling for overflowing content */
  display: flex;
  flex-direction: column;
  justify-content: flex-start; /* Align the content at the top of the container */
  text-align: left; /* Content alignment inside */
}
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="welcome-text-container">
          <h1 class="welcome-text">Welcome to SyncAura</h1>
        </div>
      </div>
    </div>
  </div>
