...
<body>
    ...
    <button class="cool-button" onclick="window.location.href='../../model/users/login.php'">client</button>
    <button class="cool-button" onclick="window.location.href='../../model/admin/login.php'">admin</button>
</div>
