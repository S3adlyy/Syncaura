...
include 'C:\xamp\htdocs\integration3\controller\packP.php';
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-lg-9">
            ...
            <a href="des.php" class="small mr-3"><span class="icon-envelope mr-2"></span> <span class="d-none d-lg-inline-block" >aide  choix du pack</span></a> 
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="pack-card">
                ...
                <div class="pack-image">
                    ...
                    if (!empty($imageName)) {
                        ...
                        $imagePath = "http://localhost/integration3/view/dash/image_bdd/" . $imageFileName;
